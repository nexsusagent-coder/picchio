...
export const initialData: MenuData = {
  ...
  categories: [
    ...
    { id: "c13", name: "KAHVELER & MOKTEYLLER", order: 13, isActive: true },
    { id: "c14", name: "SICAK İÇECEKLER & SOFT DRINK'S", order: 14, isActive: true },
  ...
  items: [
    ...
    { id: "i-spec-6", categoryId: "c11", name: "PICCHIO SURPRISE", price: 399, isAvailable: true, isSignature: true, tags: ["Tatlı", "Meyveli"], description: "Gizli tarif — her seferinde farklı bir deneyim", ingredients: "…Secret…" },
    { id: "i-spec-7", categoryId: "c11", name: "COFFEINA", price: 449, isAvailable: true, isSignature: true, isRecommended: true, tags: ["Sert", "Kahveli"], image: "/cocktail-coffeina.png", description: "Havana rom ve likör karışımıyla hazırlanan yoğun kahveli kokteyl", ingredients: "Havana · Disaronno · Baileys · Kahlua · Krema · Muz", allergens: ["Sülfitler", "Süt Ürünleri"] },
    ...
    // --- FIÇI BİRALAR ---
    { id: "i-fici-1", categoryId: "c1", name: "GUINNESS", volume: "25cl / 50cl", isAvailable: true, ingredients: "Su, Arpa Maltı, Arpa, Şerbetçiotu", allergens: ["Glüten"], tags: ["Sert"] },
    { id: "i-fici-2", categoryId: "c1", name: "TUBORG 100 MALT", volume: "33cl / 50cl / 100cl", isAvailable: true, ingredients: "Su, Arpa Maltı, Şerbetçiotu", allergens: ["Glüten"] },
    { id: "i-fici-3", categoryId: "c1", name: "TUBORG GOLD MALT", volume: "2.5l Biraver", isAvailable: true, ingredients: "Su, Arpa Maltı, Şerbetçiotu", allergens: ["Glüten"] },
    { id: "i-fici-4", categoryId: "c1", name: "Carlsberg", volume: "33cl / 50cl / 100cl / 2.5l", isAvailable: true, ingredients: "Su, Arpa Maltı, Şerbetçiotu", allergens: ["Glüten"] },
    { id: "i-fici-5", categoryId: "c1", name: "Carlsberg LUNA", volume: "33cl / 50cl", isAvailable: true, ingredients: "Su, Arpa Maltı, Şerbetçiotu, Doğal Aroma", allergens: ["Glüten"] },
    { id: "i-fici-6", categoryId: "c1", name: "1664 BLANC", volume: "33cl / 50cl", isAvailable: true, ingredients: "Su, Buğday Maltı, Arpa Maltı, Şerbetçiotu, Kişniş, Portakal Kabuğu", allergens: ["Glüten"] },
    { id: "i-fici-7", categoryId: "c1", name: "FREDERIK YAKIMA IPA", volume: "33cl", isAvailable: true, ingredients: "Su, Arpa Maltı, Yakima Şerbetçiotu", allergens: ["Glüten"] },
    { id: "i-fici-8", categoryId: "c1", name: "Weihenstephan HEFEWEISSBIER", volume: "33cl / 50cl", isAvailable: true, ingredients: "Su, Buğday Maltı, Arpa Maltı, Şerbetçiotu, Maya", allergens: ["Glüten"] },
    { id: "i-fici-9", categoryId: "c1", name: "KILKENNY", volume: "25cl / 50cl", isAvailable: true, ingredients: "Su, Arpa Maltı, Şerbetçiotu, Maya", allergens: ["Glüten"] },

    // --- ŞİŞE BİRALAR ---
    { id: "i-sise-1", categoryId: "c2", name: "GUINNESS (44cl Kutu)", price: 279, isAvailable: true, allergens: ["Glüten"] },
    { id: "i-sise-2", categoryId: "c2", name: "TUBORG 100 MALT (50cl)", price: 159, isAvailable: true, allergens: ["Glüten"] },
    { id: "i-sise-3", categoryId: "c2", name: "TUBORG ICE (33cl)", price: 199, isAvailable: true, allergens: ["Glüten"] },
    { id: "i-sise-4", categoryId: "c2", name: "TUBORG 100 Filtresiz MALT (50cl)", price: 199, isAvailable: true, allergens: ["Glüten"] },
    { id: "i-sise-5", categoryId: "c2", name: "TUBORG 100 MALT Amber (50cl)", price: 199, isAvailable: true, allergens: ["Glüten"] },
    { id: "i-sise-6", categoryId: "c2", name: "Carlsberg (50cl)", price: 169, isAvailable: true, allergens: ["Glüten"] },
    { id: "i-sise-7", categoryId: "c2", name: "Carlsberg LUNA (50cl)", price: 199, isAvailable: true, allergens: ["Glüten"] },
    { id: "i-sise-8", categoryId: "c2", name: "1664 BLANC (33cl)", price: 229, isAvailable: true, allergens: ["Glüten"] },
    { id: "i-sise-9", categoryId: "c2", name: "FREDERIK Serisi (35cl)", price: 229, isAvailable: true, allergens: ["Glüten"], description: "India Pale Ale, Yakima IPA, Wheat IPA, Marzen Lager, Brown Ale, Local, Meipa" },
    { id: "i-sise-10", categoryId: "c2", name: "SOL CERVEZA (33cl)", price: 239, isAvailable: true, allergens: ["Glüten"] },
    { id: "i-sise-11", categoryId: "c2", name: "DESPERADOS (33cl)", price: 239, isAvailable: true, allergens: ["Glüten"], ingredients: "Bira, Tekila Aroması" },
    { id: "i-sise-12", categoryId: "c2", name: "Weihenstephan (33cl)", price: 239, isAvailable: true, allergens: ["Glüten"], description: "HEFEWEISSBIER / VITUS" },
    { id: "i-sise-13", categoryId: "c2", name: "GRIMBERGEN (33cl)", price: 225, isAvailable: true, allergens: ["Glüten"], description: "BLONDE / DOUBLE AMBREE" },
    ...
    { id: "i-whi-2", categoryId: "c3", name: "JAMESON", variants: [{label:"Tek", price: 320}, {label:"Duble", price: 510}], isAvailable: true, ingredients: "İrlanda Whiskey, %40 ABV", allergens: ["Sülfitler", "Glüten"] },
    { id: "i-whi-3", categoryId: "c3", name: "CHIVAS REGAL", variants: [{label:"Tek", price: 350}, {label:"Duble", price: 550}], isAvailable: true, ingredients: "Blended Scotch Whisky, %40 ABV", allergens: ["Sülfitler", "Glüten"] },
    { id: "i-whi-4", categoryId: "c3", name: "CHIVAS 18", variants: [{label:"Tek", price: 500}, {label:"Duble", price: 750}], isAvailable: true, ingredients: "Premium Blended Scotch, %40 ABV", allergens: ["Sülfitler", "Glüten"] },
    { id: "i-whi-5", categoryId: "c3", name: "J. WALKER BLACK LABEL", variants: [{label:"Tek", price: 350}, {label:"Duble", price: 550}], isAvailable: true, ingredients: "Blended Scotch Whisky, %40 ABV", allergens: ["Sülfitler", "Glüten"] },
    ...
    { id: "i-whi-7", categoryId: "c3", name: "MACALLAN 12", variants: [{label:"Tek", price: 450}, {label:"Duble", price: 700}], isAvailable: true, ingredients: "Single Malt Scotch, Sherry Oak, %40 ABV", allergens: ["Sülfitler", "Glüten"] },
    { id: "i-whi-8", categoryId: "c3", name: "JIM BEAM", variants: [{label:"Tek", price: 350}, {label:"Duble", price: 550}], isAvailable: true, ingredients: "Kentucky Bourbon, %40 ABV", allergens: ["Sülfitler", "Glüten"] },
    ...
    // --- LİKÖR & VERMUT ---
    { id: "i-lik-1", categoryId: "c7", name: "KAHLUA / MALIBU / LEMONCELLO / ŞEFTALİ / NANE", price: 250, isAvailable: true, ingredients: "Çeşitli meyve ve bitki bazlı likörler", allergens: ["Sülfitler", "Süt Ürünleri"] },
    ...
    { id: "i-lik-3", categoryId: "c7", name: "DISARONNO", price: 300, isAvailable: true, ingredients: "Amaretto Likörü, Badem Aroması, %28 ABV", allergens: ["Sülfitler", "Kabuklu Yemişler"] },
    ...
    { id: "i-asc-1", categoryId: "c9", name: "IRISH COFFEE", price: 399, isAvailable: true, ingredients: "İrlanda Whiskey, Espresso, Şeker, Krema", allergens: ["Sülfitler", "Süt Ürünleri"] },
    { id: "i-asc-2", categoryId: "c9", name: "BAILEYS COFFEE", price: 399, isAvailable: true, ingredients: "Baileys, Espresso, Krema", allergens: ["Sülfitler", "Süt Ürünleri"] },
    { id: "i-asc-3", categoryId: "c9", name: "PICCHIO COFFEE", price: 399, isAvailable: true, ingredients: "Özel likör karışımı, Espresso, Krema", allergens: ["Sülfitler", "Süt Ürünleri"] },
    ...
    // --- KAHVELER & MOKTEYLLER ---
    { id: "i-kah-1", categoryId: "c13", name: "ESPRESSO", variants: [{label:"Single", price: 169}, {label:"Double", price: 179}], isAvailable: true, ingredients: "100% Arabica Çekirdeği" },
    { id: "i-kah-2", categoryId: "c13", name: "AMERICANO", price: 189, isAvailable: true, ingredients: "Espresso, Sıcak Su" },
    { id: "i-kah-3", categoryId: "c13", name: "LATTE", price: 199, isAvailable: true, ingredients: "Espresso, Buharda Süt", allergens: ["Süt Ürünleri"] },
    { id: "i-kah-4", categoryId: "c13", name: "CAPPUCCINO", price: 199, isAvailable: true, ingredients: "Espresso, Buharda Süt, Süt Köpüğü", allergens: ["Süt Ürünleri"] },
    { id: "i-kah-5", categoryId: "c13", name: "MOCHA (Klasik / White / Caramel)", price: 229, isAvailable: true, ingredients: "Espresso, Süt, Çikolata Sosu, Krema", allergens: ["Süt Ürünleri"] },
    { id: "i-kah-6", categoryId: "c13", name: "ALKOLSÜZ MOKTEYL (Cool Lime, Berry Hibiscus vb.)", price: 249, isAvailable: true, tags: ["Alkolsüz", "Ferah"], ingredients: "Taze Meyveler, Şeker Şurubu, Soda" },

    // --- SICAK İÇECEKLER & SOFT DRINK'S ---
    { id: "i-sic-1", categoryId: "c14", name: "Çay", variants: [{label:"Bardak", price: 70}, {label:"Fincan", price: 100}], isAvailable: true },
    { id: "i-sic-2", categoryId: "c14", name: "Türk Kahvesi", price: 149, isAvailable: true, ingredients: "Türk Kahve Çekirdeği" },
    { id: "i-sic-3", categoryId: "c14", name: "Salep", price: 149, isAvailable: true, ingredients: "Salep, Süt, Tarçın", allergens: ["Süt Ürünleri"] },
    { id: "i-sic-4", categoryId: "c14", name: "Sıcak Çikolata", price: 149, isAvailable: true, ingredients: "Çikolata, Süt, Krema", allergens: ["Süt Ürünleri"] },
    { id: "i-sic-5", categoryId: "c14", name: "Bitki Çayları", price: 149, isAvailable: true },
    { id: "i-sic-6", categoryId: "c14", name: "Cola / Fanta / Sprite / Fuse Tea", price: 129, isAvailable: true },
    { id: "i-sic-7", categoryId: "c14", name: "REDBULL", price: 169, isAvailable: true },
    { id: "i-sic-8", categoryId: "c14", name: "Su", price: 49, isAvailable: true },
    { id: "i-sic-9", categoryId: "c14", name: "Soda", price: 89, isAvailable: true },
    { id: "i-sic-10", categoryId: "c14", name: "Meyveli Soda", price: 99, isAvailable: true },
    { id: "i-sic-11", categoryId: "c14", name: "Churchill", price: 159, isAvailable: true },
    ...
    { id: "i-yem-13", categoryId: "c15", name: "Turşu", price: 100, isAvailable: true },
  ]
};
