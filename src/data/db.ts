...
export const initialData: MenuData = {
  ...
  items: [
    ...
    // --- FIÇI BİRALAR ---
    { id: "i-fici-1", categoryId: "c1", name: "GUINNESS", volume: "25cl / 50cl", isAvailable: true, ingredients: "Su, Arpa Maltı, Şerbetçiotu", allergens: "Glüten, Sülfitler", tags: ["Sert"] },
    ...
    // --- ŞİŞE BİRALAR ---
    { id: "i-sise-1", categoryId: "c2", name: "GUINNESS (44cl Kutu)", price: 279, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "44cl" },
    { id: "i-sise-2", categoryId: "c2", name: "TUBORG 100 MALT (50cl)", price: 159, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "50cl" },
    { id: "i-sise-3", categoryId: "c2", name: "TUBORG ICE (33cl)", price: 199, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "33cl" },
    { id: "i-sise-4", categoryId: "c2", name: "TUBORG 100 Filtresiz MALT (50cl)", price: 199, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "50cl" },
    { id: "i-sise-5", categoryId: "c2", name: "TUBORG 100 MALT Amber (50cl)", price: 199, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "50cl" },
    { id: "i-sise-6", categoryId: "c2", name: "Carlsberg (50cl)", price: 169, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "50cl" },
    { id: "i-sise-7", categoryId: "c2", name: "Carlsberg LUNA (50cl)", price: 199, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "50cl" },
    { id: "i-sise-8", categoryId: "c2", name: "1664 BLANC (33cl)", price: 229, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "33cl" },
    { id: "i-sise-9", categoryId: "c2", name: "FREDERIK Serisi (35cl)", price: 229, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "35cl", description: "India Pale Ale, Yakima IPA, Wheat IPA, Marzen Lager, Brown Ale, Local, Meipa" },
    { id: "i-sise-10", categoryId: "c2", name: "SOL CERVEZA (33cl)", price: 239, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "33cl" },
    { id: "i-sise-11", categoryId: "c2", name: "DESPERADOS (33cl)", price: 239, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "33cl", ingredients: "Bira, Tekila Aroması" },
    { id: "i-sise-12", categoryId: "c2", name: "Weihenstephan (33cl)", price: 239, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "33cl", description: "HEFEWEISSBIER / VITUS" },
    { id: "i-sise-13", categoryId: "c2", name: "GRIMBERGEN (33cl)", price: 225, isAvailable: true, allergens: "Glüten, Sülfitler", volume: "33cl", description: "BLONDE / DOUBLE AMBREE" },
    ...
    // --- VOTKA'S ---
    { id: "i-vot-1", categoryId: "c4", name: "ABSOLUT", price: 300, isAvailable: true, ingredients: "İsveç Votkası, %40 ABV", description: "Klasik, Vanilia, Citron, Raspberry", allergens: "Sülfitler", volume: "5cl" },
    { id: "i-vot-2", categoryId: "c4", name: "SMIRNOFF", price: 300, isAvailable: true, ingredients: "Triple Distilled Votka, %40 ABV", allergens: "Sülfitler", volume: "5cl" },
    { id: "i-vot-3", categoryId: "c4", name: "BELVEDERE", price: 450, isAvailable: true, ingredients: "Polonya Premium Votka, %40 ABV", allergens: "Sülfitler", volume: "5cl" },

    // --- GIN'S ---
    { id: "i-gin-1", categoryId: "c5", name: "BEEFEATER / PINK", price: 300, isAvailable: true, ingredients: "London Dry Gin, Ardıç, %40 ABV", allergens: "Sülfitler", volume: "5cl" },
    { id: "i-gin-2", categoryId: "c5", name: "GORDON'S", price: 300, isAvailable: true, ingredients: "London Dry Gin, Ardıç, %37.5 ABV", allergens: "Sülfitler", volume: "5cl" },
    { id: "i-gin-3", categoryId: "c5", name: "BOMBAY SAPPHIRE", price: 400, isAvailable: true, ingredients: "Vapour Infused Gin, 10 Botanik, %40 ABV", allergens: "Sülfitler", volume: "5cl" },

    // --- ROM'S & COGNAC ---
    { id: "i-rom-1", categoryId: "c6", name: "HAVANA / BACARDI / CAPTAIN MORGAN", price: 350, isAvailable: true, ingredients: "Karayip Romu, %40 ABV", allergens: "Sülfitler", volume: "5cl" },
    ...
    { id: "i-lik-4", categoryId: "c7", name: "GARRONE Serisi", variants: [{label:"Triple Sec / Rosso", price: 250}, {label:"Extra Dry / Bianco", price: 300}], isAvailable: true, description: "Triple Sec / Rosso / Extra Dry / Bianco", ingredients: "İtalyan Vermut, Botanikler", allergens: "Sülfitler" },
    ...
    { id: "i-kah-1", categoryId: "c13", name: "ESPRESSO", volume: "Single", price: 169, isAvailable: true, ingredients: "100% Arabica Çekirdeği", allergens: "Kafein" },
    { id: "i-kah-2", categoryId: "c13", name: "ESPRESSO Double", volume: "Double", price: 179, isAvailable: true, ingredients: "100% Arabica Çekirdeği", allergens: "Kafein" },
    { id: "i-kah-3", categoryId: "c13", name: "AMERICANO", price: 189, isAvailable: true, ingredients: "Espresso, Sıcak Su", allergens: "Kafein" },
    { id: "i-kah-4", categoryId: "c13", name: "LATTE", price: 199, isAvailable: true, ingredients: "Espresso, Buharda Süt", allergens: "Kafein, Süt Ürünleri" },
    { id: "i-kah-5", categoryId: "c13", name: "CAPPUCCINO", price: 199, isAvailable: true, ingredients: "Espresso, Buharda Süt, Süt Köpüğü", allergens: "Kafein, Süt Ürünleri" },
    { id: "i-kah-6", categoryId: "c13", name: "MOCHA (Klasik / White / Caramel)", price: 229, isAvailable: true, ingredients: "Espresso, Süt, Çikolata Sosu, Krema", allergens: "Kafein, Süt Ürünleri" },
    { id: "i-sic-1", categoryId: "c13", name: "Çay", volume: "Bardak", price: 70, isAvailable: true, allergens: null },
    { id: "i-sic-2", categoryId: "c13", name: "Çay (Fincan)", volume: "Fincan", price: 100, isAvailable: true, allergens: null },
    { id: "i-sic-3", categoryId: "c13", name: "Türk Kahvesi", price: 149, isAvailable: true, ingredients: "Türk Kahve Çekirdeği", allergens: "Kafein" },
    { id: "i-sic-4", categoryId: "c13", name: "Salep", price: 149, isAvailable: true, ingredients: "Salep, Süt, Tarçın", allergens: "Süt Ürünleri" },
    { id: "i-sic-5", categoryId: "c13", name: "Sıcak Çikolata", price: 149, isAvailable: true, ingredients: "Çikolata, Süt, Krema", allergens: "Süt Ürünleri" },
    { id: "i-sic-6", categoryId: "c13", name: "Bitki Çayları", price: 149, isAvailable: true, allergens: null },

    // --- MOKTEYLLER & SOFT DRINKS ---
    { id: "i-mok-1", categoryId: "c14", name: "ALKOLSÜZ MOKTEYL (Cool Lime, Berry Hibiscus vb.)", price: 249, isAvailable: true, tags: ["Alkolsüz", "Ferah"], ingredients: "Taze Meyveler, Şeker Şurubu, Soda", allergens: null },
    { id: "i-sof-1", categoryId: "c14", name: "Cola / Fanta / Sprite / Fuse Tea", price: 129, isAvailable: true, allergens: null },
    { id: "i-sof-2", categoryId: "c14", name: "REDBULL", price: 169, isAvailable: true, allergens: "Kafein" },
    { id: "i-sof-3", categoryId: "c14", name: "Su", price: 49, isAvailable: true, allergens: null },
    { id: "i-sof-4", categoryId: "c14", name: "Soda", price: 89, isAvailable: true, allergens: null },
    { id: "i-sof-5", categoryId: "c14", name: "Meyveli Soda", price: 99, isAvailable: true, allergens: null },
    { id: "i-sof-6", categoryId: "c14", name: "Churchill", price: 159, isAvailable: true, allergens: null },
