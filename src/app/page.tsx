...
export default function SplashScreen() {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <div className="w-full max-w-md mx-auto relative h-screen">
          <motion.div
            key="splash"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            ...
            style={{
              background: "linear-gradient(to bottom, #420808 0%, #1a0404 50%, #000000 100%)"
            }}
          >
            ...
            >
              ...
              <img
                ...
                className="absolute inset-0 w-full h-full object-contain drop-shadow-[0_0_15px_rgba(212,175,55,0.4)]"
              />
            </motion.div>
          </motion.div>
        </div>
